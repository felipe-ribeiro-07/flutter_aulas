      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        onPressed: () {},
                        icon: Icon(Icons.add, color: Color(0xFFcc2145)),
                      ),
                    ],
                  ),
                ),
            ...
            Row(
              children: [
                const Icon(Icons.lock, color: Color(0xFF161616), size: 20),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Icon(Icons.help, color: Colors.black54, size: 16),
                  ],
                ),
              ...
              children: const [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "/ 1 item",
                      style: TextStyle(color: Color(0xFFa8a8a8), fontSize: 15),
                    ),
                  ],
                ),
              ],
